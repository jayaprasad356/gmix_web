...
@section('content-header', 'Categories Management')
@section('content-actions')
    <a href="{{ route('categories.create') }}" class="btn btn-success"><i class="fas fa-plus"></i> Add New Categories</a>
@endsection
        ...
        <div class="table-responsive">
            <table class="table table-bordered table-hover">
                ...
                <tbody>
                    ...
                    <tr>
                    <td>
                            <a href="{{ route('categories.edit', $categorie) }}" class="btn btn-primary"><i class="fas fa-edit"></i></a>
                            <button class="btn btn-danger btn-delete" data-url="{{route('categories.destroy', $categorie)}}"><i class="fas fa-trash"></i></button>
                        </td>
                        <td>{{$categorie->id}}</td>
                        <td>{{$categorie->name}}</td>
                        <td>
                            <a href="{{ asset('storage/app/public/categories/' . $categorie->image) }}" data-lightbox="image-{{ $categorie->id }}">
                                <img class="customer-img img-thumbnail img-fluid" src="{{ asset('storage/app/public/categories/' . $categorie->image) }}" alt="Image" style="max-width: 100px; max-height: 100px;">
                            </a>
                         </td>
                    </tr>
                    @endforeach
