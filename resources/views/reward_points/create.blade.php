...
@section('title', 'Create Reward points')
@section('content-header', 'Create Reward points')
@section('content-actions')
    <a href="{{route('reward_points.index')}}" class="btn btn-success"><i class="fas fa-back"></i>Back To Reward Points</a>
@endsection
@section('content')
    ...
    <div class="card">
        <div class="card-body">
            ...
            <form action="{{ route('reward_points.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
